...
Automated outputs, including hazard labels, risk markers, measurements, reconstructed models and recommendations, include model confidence and review status. False negatives are treated as a critical evaluation category in a mine-safety context because a missed hazard can create unsafe decisions. Recommendations produced by the system are routed for competent human review before field action.
